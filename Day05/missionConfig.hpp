...
{  
	class End1
	{
		...
		subtitle = "Bullseye";
		description = "DEVGRU: Well done men. Vodka and medals await upon your return!";
		pictureBackground = "Img\intro_day5.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
	...
	class End2
	{
		...
		subtitle = "Bullseye";
		description = "DEVGRU: We need that Intel! Commander, prepare your man to return to Pygros";
		pictureBackground = "Img\intro_day5.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
	class Killed
