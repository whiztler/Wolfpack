...
// Ambient flyby's	
_fbEndPos = [] call fbEndPos; [getMarkerPos "mAFB1a", getMarkerPos _fbEndPos, 20, "NORMAL", "O_Heli_Attack_02_F", EAST] call BIS_fnc_ambientFlyby; sleep 0.035;
...
_fbEndPos = [] call fbEndPos; [getMarkerPos "mAFB1b", getMarkerPos _fbEndPos, 50, "NORMAL", "O_Heli_Attack_02_F", EAST] call BIS_fnc_ambientFlyby; sleep 6;
