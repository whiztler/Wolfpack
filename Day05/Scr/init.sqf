...
if (hasInterface) then {
	...
	hint parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>DEVGRU: Commander, call signs are as follows:<br/><br/>DEVGRU TOC: </t><t color='#9DA698' align='left'>Cowboy.</t><br /><t color='#6C7169' align='left'>Your call sign: </t><t color='#9DA698' align='left'>Cougar.<br/></t>";
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Cowboy: Cougar, head out to RV XRay. Niko's crew dropped off supplies at Chelonisi in case yours have water damage.</t><br/><br/><t color='#6C7169' align='left'>Pyrgos is busy as always with CSAT patrols, civilians, etc. You know what to do Cougar</t><br/><t color='#6C7169' align='left'>Exfil is at </t><t color='#9DA698' align='left'>LZ Sundance</t><t color='#6C7169' align='left'>. More details to follow.</t><br/><br/><t color='#6C7169' align='left'>Good luck! Cowboy out.<br/></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Cowboy: Cougar, we just picked up two CSAT navy patrols on Satnav. Keep your head down!<br/></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
