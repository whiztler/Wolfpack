hint parseText"
	...
	<t color='#6C7169' align='left'>Eagle Eye: once you have cleared the area, </t><t color='#9DA698' align='left'>tag </t><t color='#6C7169' align='left'>the radar towers and radar installation by approaching them up close.</t><br/><br/>
	<t color='#6C7169' align='left'>Once all the targets have been tagged, you'll be able to call in a missile strike using </t><t color='#9DA698' align='left'>Radio Delta [0-0-4].<br/></t>
";
