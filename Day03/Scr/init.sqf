...
hint parseText"
	...
	<t color='#6C7169' align='left'>DEVGRU: Commander, call signs are as follows:<br/><br/>DEVGRU TOC: </t><t color='#9DA698' align='left'>Eagle Eye</t><br /><t color='#6C7169' align='left'>Your call sign: </t><t color='#9DA698' align='left'>Eightball.<br/></t>
";
...
hint parseText"
	<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/>
	<t color='#6C7169' align='left'>Eagle Eye: Eightball, move to the </t><t color='#9DA698' align='left'>RV </t><t color='#6C7169' align='left'>and meet up with Niko Fotopoulos. He'll brief you re your orders.<br/></t>
";
_logTime = [dayTime] call BIS_fnc_timeToString;
_logTimeText = "Log: " + _logTime;
player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
...
hint parseText"
	<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/>
	<t color='#6C7169' align='left'>Eagle Eye: Niko will bring extra supplies and radios. Your backpacks should carry land weapons/supplies.<br/></t>
";
_logTime = [dayTime] call BIS_fnc_timeToString;
_logTimeText = "Log: " + _logTime;
player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
...
hint parseText"
	<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/>
	<t color='#6C7169' align='left'>Eagle Eye: We have supplied your team with LRI Tagging stickers. The stickers can be attached to targets for long-range strike capability. Niko will fill you in.<br/></t>
";
_logTime = [dayTime] call BIS_fnc_timeToString;
_logTimeText = "Log: " + _logTime;
player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
