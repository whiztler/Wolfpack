...
if (hasInterface) then {
	hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>All radar towers and radar equipment have been tagged.<br/><br/>Blizzard is on station for a fire mission.<br/></t>";
...
if (!isDedicated) then {
	waitUntil {sleep 2; !isNil "trBlizzard"};
