...
{  
	class End1
	{
		...
		pictureBackground = "Img\intro_day9.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
	...
	class End2
	{
		...
		subtitle = "DragonFly";
		description = "Uncle: back to boot camp for you lot!!";
		pictureBackground = "Img\intro_day9.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
	class Killed
	{
		...
		subtitle = "DragonFly";
		description = "Uncle: Rest in Peace Wolf, R.I.P.!";
		pictureBackground = "Img\intro_day9.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};		
};
