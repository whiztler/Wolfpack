wpEnd = false;
waitUntil {sleep 3; objDone};

if (hasInterface) then {
	hintSilent parseText"<img size= '5' shadow='false' image='Img\soar_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Cowboy, this is Raven. We're your ride home boys.</t><br/><br/><t color='#9DA698' align='left'>ETA 5 mikes.</t><br/><br/><t color='#6C7169' align='left'>Please make sure we drop into a clean LZ.</t><br/>";
	...
	sleep 3;
	hintSilent parseText"<img size= '5' shadow='false' image='Img\soar_logo.paa'/><br/><br/><t color='#6C7169' align='left'>160th SOAR Lt. McAllistar: Dusting off in 30 seconds!<br/></t>";
	sleep 3;
...
if (isServer) then { 
	...
	_wp2 setWaypointStatements ["true", "hintSilent parseText""<img size= '5' shadow='false' image='Img\soar_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Raven: Cowboy please pop smoke or a chemlight to mark the LZ.</t>"";"];
