hint parseText"
	...
	<t color='#6C7169' align='left'>Eagle Eye this is Cowboy, we are closing in to the airbase. How copy?<br/></t>
";
...
hint parseText"
	...
	<t color='#6C7169' align='left'>Eagle Eye: Copy Cowboy. Move in closer. We are repositioning the satellite. Standby for orders.</t><br/>
";
...
hint parseText"
	<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/>
	<t color='#6C7169' align='left'>Eagle Eye: Cowboy, SatNav shows nine or ten TO-199's. These can be a real pain in the ass during the campaign. You have been tasked to them them out.</t><br/><br/>
	<t color='#6C7169' align='left'>Cowboy, you orders are to destroy any and all TO-199 fight jet aircraft at Stratis Airbase. We have</t>
	<t color='#9DA698' align='left'> 9 </t>
	<t color='#6C7169' align='left'>confirmed targets.</t><br/><br/>
	<t color='#6C7169' align='left'>Good luck Cowboy!</t><br/>
";
_logTime = [dayTime] call BIS_fnc_timeToString;
_logTimeText = "Log: " + _logTime;
player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
...
if (isServer) then {
	...
	[_c, getMarkerPos "cApt", 1500, 5, "SAD", "SAFE", "RED", "FAST", "", "", [10,60,120]] call CBA_fnc_taskPatrol;
	sleep 10;
	_c = createGroup EAST;	
...
hint parseText"
	<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/>
	<t color='#6C7169' align='left'>Eagle Eye: Good job Cowboy. SatNav advices that all TO-199's have been neutralized.</t><br/><br/>
	<t color='#6C7169' align='left'>Head towards Limeri Bay, south east of the Island. We'll have a ride home at </t>
	<t color='#9DA698' align='left'>LZ Bombay</t>	
	<t color='#6C7169' align='left'>.</t><br/>
";
_logTime = [dayTime] call BIS_fnc_timeToString;
_logTimeText = "Log: " + _logTime;
player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
