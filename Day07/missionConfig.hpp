...
{  
	class End1
	{
		...
		subtitle = "U-12";
		description = "Gator: Well done men. Vodka and medals await upon your return!";
		pictureBackground = "Img\intro_day7.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
	...
	class End2
	{
		...
		subtitle = "U-12";
		description = "Gator: With Nikos K.I.A. we have lost a high value asset. Unacceptable!";
		pictureBackground = "Img\intro_day7.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
	class Killed
	{
		...
		subtitle = "U-12";
		description = "Gator: We'll inform you loved ones of your brave attempt to complete this operation!";
		pictureBackground = "Img\intro_day7.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};		
};
