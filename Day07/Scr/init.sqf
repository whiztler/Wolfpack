...
if (hasInterface) then {
	...
	hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>DEVGRU: Commander, call signs are as follows:<br/><br/>DEVGRU TOC: </t><t color='#9DA698' align='left'>Gator.</t><br /><t color='#6C7169' align='left'>Your call sign: </t><t color='#9DA698' align='left'>Beagle.<br/></t>";
	...
	hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Gator: Beagle, Niko's men will be waiting at the RV. They'll provide security for your assault vessels.</t><br/><br/><t color='#6C7169' align='left'>They have hidden a small ammo cache at </t><t color='#9DA698' align='left'>Atinarki</t><t color='#6C7169' align='left'>, just west of the RV, in case you need additional supplies.<br/></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Gator: You'll be using your assault vessels for exfil as well. Do not damage them else you'll be stuck on Altis.</t><br/>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
...
WP_fnc_NikkosKIA = {
	...
	hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Gator: Beagle, we just received word that the package is K.I.A. Mission aborted. RTB asap!<br/></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
...
WP_fnc_nikkosRescued = {
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\wolf_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Beagle: Gator this is Beagle, we have the package, I repeat we have the package. How copy?<br/></t>";	
	sleep 10;
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Gator: Good job Beagle. Escort the package back to the RV. Have the package board the assault vessel and head south east towards the exfil location where the USS Anchorage will pick you up.<br/><br/></t><t color='#6C7169' align='left'>I repeat, the package has to be on board as we need to debrief him. We'll drop him off at Altis after the debrief.<br/></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Gator: Did you copy Beagle?. Escort the package back to the RV. Have the package board the assault vessel and head south east towards the exfil location where the USS Anchorage will pick you up.<br/><br/></t><t color='#6C7169' align='left'>I repeat, the package has to be on board as we need to debrief him. We'll drop him off at Altis once we have debriefed him.<br/></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
...
[] spawn {
	waitUntil {sleep 4; NikkosRescued};
	private "_wait"
	_wait = ((random 200) + (random 200));
	...
	if (hasInterface) then {
		sleep 5;
		hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Gator: We just received intel from SatNav that several vehicles have left Pyrgos and are heading your way.</t><br/><t color='#6C7169' align='left'>No matter what, you make sure you get the package to safety asap.<br/></t>";
		_logTime = [dayTime] call BIS_fnc_timeToString;
		_logTimeText = "Log: " + _logTime;
		player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
		<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
		...
		sleep _wait;
		hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Gator: Satnav reports a Kajman gunship just took off from Abdera Heliport and is heading towards U-12. ETA 4 Mikes.<br/></t>";
		_logTime = [dayTime] call BIS_fnc_timeToString;
		_logTimeText = "Log: " + _logTime;
		player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
		<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
...
[] spawn {
	...
	waitUntil {sleep 5; NikkosRescued};
...
[_c, getmarkerpos "mVP1", 3000, 5, "MOVE", "SAFE", "RED", "LIMITED", 25] call ADF_fnc_vehiclePatrol;
_c = createGroup EAST; _v = [getMarkerPos "mVP2", 90, "O_Truck_02_covered_F", _c] call BIS_fnc_spawnVehicle;
[_c, getmarkerpos "mVP2", 3000, 5, "MOVE", "SAFE", "RED", "LIMITED", 25] call ADF_fnc_vehiclePatrol;
_c = createGroup EAST; _v = [getMarkerPos "mVP3", 90, "O_APC_Tracked_02_cannon_F", _c] call BIS_fnc_spawnVehicle;
[_c, getmarkerpos "mVP3", 3000, 5, "MOVE", "SAFE", "RED", "LIMITED", 25] call ADF_fnc_vehiclePatrol;
sleep 30;
_c = createGroup EAST; _v = [getMarkerPos "mVP1", 90, "O_APC_Tracked_02_AA_F", _c] call BIS_fnc_spawnVehicle;
[_c, getmarkerpos "mVP1", 5000, 6, "MOVE", "SAFE", "RED", "LIMITED", 25] call ADF_fnc_vehiclePatrol;
_c = createGroup EAST; _v = [getMarkerPos "mVP2", 90, "O_Truck_02_Ammo_F", _c] call BIS_fnc_spawnVehicle;
[_c, getmarkerpos "mVP2", 2500, 4, "MOVE", "SAFE", "RED", "LIMITED", 25] call ADF_fnc_vehiclePatrol;
_c = createGroup EAST; _v = [getMarkerPos "mVP3", 90, "O_Truck_02_fuel_F", _c] call BIS_fnc_spawnVehicle;
[_c, getmarkerpos "mVP3", 2500, 4, "MOVE", "SAFE", "RED", "LIMITED", 25] call ADF_fnc_vehiclePatrol;
