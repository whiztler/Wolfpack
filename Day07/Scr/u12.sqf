hint parseText"
	...
	<t color='#6C7169' align='left'>Gator: Beagle, we have you closing in on the objective on SatNav. Once inside, find Nikos and assign him to your group. A action menu will be available once you are in close proximity of Nikos.<br/><br/>
	Good luck Beagle!<br/></t>
";
