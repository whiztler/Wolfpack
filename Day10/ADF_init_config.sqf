...
_ADF_ambient_uCiv_nr = 3; // number of civilians to spawn around the players. This nr. is the max nr. of civilian spawns (no matter the amount of players).
...
_ADF_ambient_vCiv_nr = 3; // number of vehicles to spawn around the players. This nr. is the max nr. of civilian vehicle spawns (no matter the amount of players).
_ADF_ambient_vCiv_dist = 500; // Vehicle spawn distance from player in meters.
_ADF_ambient_vCiv_del = 700; // Vehicle delete distance from player in meters.
...
_ADF_devBuildNr = "15"; // Build number. DO NOT EDIT