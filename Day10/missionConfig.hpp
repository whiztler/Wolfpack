...
{  
	class End1
	{
		...
		subtitle = "Doberman";
		description = "Caesar: Well done Wolf! This mission was the crown on your track record!";
		pictureBackground = "Img\intro_day10.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
	...
	class End2
	{
		...
		subtitle = "Doberman";
		description = "Caesar: With the HVT out of the way CSAT would be in total disarray. I've already dispatched another troop. You're dismissed!";
		pictureBackground = "Img\intro_day10.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
	class Killed
	{
		...
		subtitle = "Doberman";
		description = "Uncle: rest in peace Wolf!";
		pictureBackground = "Img\intro_day10.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};		
};	
