...
if (hasInterface) then {
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>DEVGRU: Commander, call signs are as follows:<br/><br/>DEVGRU TOC: </t><t color='#9DA698' align='left'>Caesar</t><br /><t color='#6C7169' align='left'>Your call sign: </t><t color='#9DA698' align='left'>Nightshade</t>";
	...
	hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Caesar: Nightshade, head towards the coast. The objective is in Kavala. Nikkos men dropped off supplies at</t><t color='#9DA698' align='left'> RV Helsinki </t><t color='#6C7169' align='left'>in case you need additional dry gear.</t><br/><br/><t color='#6C7169' align='left'>We'll brief you re your mission in a few minutes Nightshade. We're still processing intel we just received from Nikkos.</t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
	...
	for "_i" from 1 to 20 do {
		hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Caesar: Nightshade, a few days ago we received intel re General Tehrani's (codename: '</t><t color='#9DA698' align='left'>Doberman</t><t color='#6C7169' align='left'>') plans to visit Kavala.</t><br/><br/><t color='#6C7169' align='left'>Nikos tried to apprehend Doberman's travel itinerary and schedule. Unfortunately he was unsuccessful.</t><br/><t color='#6C7169' align='left'>This means we have no intel on his exact location at the moment. We presume Doberman is at one of the CSAT locations in Kavala as marked on your comms device and map.</t><br/><br/><t color='#9DA698' align='left'>Your orders are to find and eliminate Doberman.</t><br/><br/>";
		sleep 1;
	};

	if (isNil "MotsActive") then {sleep 55};

	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Caesar: Nightshade, we are still working on your exfil. We'll advise in due time.</t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
...
if (hasInterface) then {
	hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Caesar: Excellent work nightshade!</t><br/><br/><t color='#6C7169' align='left'>We've spotted an EVAC helicopter at the Kavala General Hospital helipad. Grab the helicopter and head south towards the USS Ronald Reagan.</t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
