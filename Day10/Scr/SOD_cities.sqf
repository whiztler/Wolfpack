...
if ((isNil "g3a") && (isNil "g3b") && (isNil "g3c") && (_this select 0 == "3A")) exitWith {
	...
	[g3b, getPos tCities3, 350, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
...
if ((isNil "g4a") && (isNil "g4b") && (isNil "g4c") && (_this select 0 == "4A")) exitWith {
	...
	[g4b, getPos tCities4, 350, 4, true] call ADF_fnc_defendArea; sleep 0.05;
};
...
if ((isNil "g5a") && (isNil "g5b") && (isNil "g5c") && (_this select 0 == "5A")) exitWith {
	...
	[g5b, getPos tCities5, 350, 4, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
