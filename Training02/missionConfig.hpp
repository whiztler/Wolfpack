...
{  
	class End1
	{
		...
		subtitle = "SO/Recon Training";
		description = "Well done. You have completed the advanced SpecOps/Recon training";
		pictureBackground = "Img\intro_training.paa";
	...
	class End2
	{
		...
		subtitle = "SO/Recon Training";
		description = "You have been detected. You cannot complete the objective";
		pictureBackground = "Img\intro_training.paa";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
};
...
class Params
{
	// paramsArray[0]
	class objTime {
		title = "Time allowed to complete the objective";
		values[] = {120,90,60,45,30};
		texts[] = {"120 minutes","90 minutes","60 minutes","45 minutes","30 minutes"};
		default = 90;
	};
	// paramsArray[1]
	class prepTime {
		...
		texts[] = {"20 minutes","15 minutes","10 minutes","5 minutes","2 minutes","1 minute"};
		default = 5;
	};	
};
