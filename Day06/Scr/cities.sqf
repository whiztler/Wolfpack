...
if ((isNil "g6a") && (isNil "g6b") && (isNil "g6c") && (_this select 0 == "AptA")) exitWith {
	...
	[g6a, getMarkerPos "mHangarApt", 150, 4, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;	
	g6b = [getMarkerPos "mHangarApt", EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
	[g6b, getMarkerPos "mHangarApt", 150, 4, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;	
};
if (_this select 0 == "Aptb") exitWith {};
