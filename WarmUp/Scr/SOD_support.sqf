...
// Arti Site
if (_this select 0 == "ARTISUP") exitWith {
	_c = createGroup EAST;
...
// Heli Airport
if (_this select 0 == "APTSUP") exitWith {
	_c = createGroup EAST;
...
// Paros
if (_this select 0 == "PAROSINNER") exitWith {
	_c = createGroup EAST;
...
// Rodopoli
if (_this select 0 == "RODOPOLIINNER") exitWith {
	_c = createGroup EAST;
...
// Fuel Depot
if (_this select 0 == "DEPOTINNER") exitWith {
