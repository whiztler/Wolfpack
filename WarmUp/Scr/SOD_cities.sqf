...
if ((isNil "gC1a") && (isNil "gC1b") && (isNil "gC1c") && (isNil "gC1d") && (isNil "gC1e") && (isNil "gC1f") && (_this select 0 == "1A")) exitWith {
	...
	[gC1a, getPos tRodopoli, 400, 5, "MOVE", "SAFE", "YELLOW", "LIMITED", "COLUMN", "this spawn CBA_fnc_taskSearchHouse", [1,4,9]] call CBA_fnc_taskPatrol; sleep 0.05;
	gC1b = [getPos tRodopoli, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
	[gC1b, getPos tRodopoli, 400, 5, "MOVE", "SAFE", "YELLOW", "LIMITED", "COLUMN", "this spawn CBA_fnc_taskSearchHouse", [1,4,9]] call CBA_fnc_taskPatrol; sleep 0.05;	
	gC1c = [getPos tRodopoli, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
	[gC1c, getPos tRodopoli, 400, 5, "MOVE", "SAFE", "YELLOW", "LIMITED", "COLUMN", "this spawn CBA_fnc_taskSearchHouse", [1,4,9]] call CBA_fnc_taskPatrol; sleep 0.05;	
...
if ((isNil "gC2a") && (isNil "gC2b") && (isNil "gC2c") && (isNil "gC2d") && (isNil "gC2e") && (isNil "gC2f") && (_this select 0 == "2A")) exitWith {
	...
	[gC2a, getPos tParos, 400, 5, "MOVE", "SAFE", "YELLOW", "LIMITED", "COLUMN", "this spawn CBA_fnc_taskSearchHouse", [1,4,9]] call CBA_fnc_taskPatrol; sleep 0.05;
	gC2b = [getPos tParos, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
	[gC2b, getPos tParos, 400, 5, "MOVE", "SAFE", "YELLOW", "LIMITED", "COLUMN", "this spawn CBA_fnc_taskSearchHouse", [1,4,9]] call CBA_fnc_taskPatrol; sleep 0.05;	
	gC2c = [getPos tParos, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
	[gC2c, getPos tParos, 400, 5, "MOVE", "SAFE", "YELLOW", "LIMITED", "COLUMN", "this spawn CBA_fnc_taskSearchHouse", [1,4,9]] call CBA_fnc_taskPatrol; sleep 0.05;	
...
if (_this select 0 == "2B") exitWith {
	if !(isNil "gC2a") then {{deleteVehicle _x} forEach units gC2a; deleteGroup gC2a; gC2a = nil}; sleep 0.035;
	if !(isNil "gC2b") then {{deleteVehicle _x} forEach units gC2b; deleteGroup gC2b; gC2b = nil}; sleep 0.035;
	if !(isNil "gC2c") then {{deleteVehicle _x} forEach units gC2c; deleteGroup gC2c; gC2c = nil}; sleep 0.035;
	if !(isNil "gC2d") then {{deleteVehicle _x} forEach units gC2d; deleteGroup gC2d; gC2d = nil}; sleep 0.035;
	if !(isNil "gC2e") then {{deleteVehicle _x} forEach units gC2e; deleteGroup gC2e; gC2e = nil}; sleep 0.035;
	if !(isNil "gC2f") then {{deleteVehicle _x} forEach units gC2f; deleteGroup gC2f; gC2f = nil}; sleep 0.035;
};
