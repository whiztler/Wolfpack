...
_ADF_ambient_uCiv_nr = 2; // number of civilians to spawn around the players. This nr. is the max nr. of civilian spawns (no matter the amount of players).
...
_ADF_ambient_vCiv_nr = 4; // number of vehicles to spawn around the players. This nr. is the max nr. of civilian vehicle spawns (no matter the amount of players).
