...
if ((isNil "g1a") && (isNil "g1b") && (isNil "g1c") && (_this select 0 == "1A")) exitWith {
	...
	[g1d, getPos oAA_4_site, 300, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
	g1e = [getPos oAA_4_site, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam")] call BIS_fnc_spawnGroup;
	[g1e, getPos oAA_4_site, 150, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
};
...
if ((isNil "g4a") && (isNil "g4b") && (isNil "g4c") && (_this select 0 == "4A")) exitWith {
	...
	[g4a, getPos tCities4, 300, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
...
if ((isNil "g5a") && (isNil "g5b") && (isNil "g5c") && (_this select 0 == "5A")) exitWith {
	...
	[g5a, getPos tCities5, 300, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
	g5b = [getPos tCities5, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
	[g5b, getPos tCities5, 300, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
...
if ((isNil "g10a") && (isNil "g10b") && (isNil "g10c") && (_this select 0 == "10A")) exitWith {
	...
	[g10a, getMarkerPos "mAbdera", 300, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;	
	g10b = [getMarkerPos "mAbdera", EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
	[g10b, getMarkerPos "mAbdera", 300, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
