if (hasInterface) then {
	...
	for "_i" from 1 to 30 do {
		hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Uncle: listen up Viper, we just got word from Nikos. He thinks that 'Ice Tiger's' location is somewhere in the following grid:</t><br/><br/><t color='#9DA698' align='center' size='1.3'>031223 - 091231</t><br/><t color='#9DA698' align='center' size='1.3'>042184 - 100164</t><br/><br/><t color='#6C7169' align='left'>The 7 x 7 Km area covers the north western tip of Altis to </t><t color='#9DA698' align='left'>Krya Nera </t><t color='#6C7169' align='left'>and all the way down to </t><t color='#9DA698' align='left'>Negades </t><t color='#6C7169' align='left'>and just north of </t>	<t color='#9DA698' align='left'>Agios Dionysios.</t><br/><br/><t color='#6C7169' align='left'>Good hunting Viper!<br/></t>";
		sleep 1;
	};
};
...
for "_i" from 1 to 15 do {
	...
	[_g, getMarkerPos _spawnPos, 1200, 5, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
	sleep 5;
};

_g = [getMarkerPos "mAbdera", EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
[_g, getMarkerPos "mAbdera", 150, 3, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
...
for "_i" from 1 to 3 do {
	...
	[_g, getMarkerPos iceTigerLoc, 250, 4, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
};
...
wp_fnc_airVehicle = {private "_airVehicle"; _airVehicle = ["O_Heli_Attack_02_F","O_Heli_Attack_02_black_F","O_Heli_Transport_04_F","O_Heli_Transport_04_ammo_F","O_Heli_Transport_04_bench_F","O_Heli_Transport_04_box_F","O_Heli_Transport_04_covered_F","O_Heli_Transport_04_fuel_F","O_Heli_Transport_04_medevac_F","O_Heli_Transport_04_repair_F","O_Heli_Light_02_unarmed_F","O_Heli_Light_02_F"] call BIS_fnc_selectRandom;_airVehicle;};
...
// Ambient flyby's	
[getMarkerPos "mAF1", getMarkerPos "mAFx", 20, "NORMAL", "O_Heli_Attack_02_F", EAST] call BIS_fnc_ambientFlyby;
[getMarkerPos "mAF2", getMarkerPos "mAFx", 15, "NORMAL", "O_Heli_Attack_02_F", EAST] call BIS_fnc_ambientFlyby;
[getMarkerPos "mAF3", getMarkerPos "mAFx", 30, "NORMAL", "O_Heli_Attack_02_F", EAST] call BIS_fnc_ambientFlyby;
