...
{  
	class End1
	{
		...
		subtitle = "Ice Tiger";
		description = "Uncle: Well done men. Vodka and medals await upon your return!";
		pictureBackground = "Img\intro_day8.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
	...
	class End2
	{
		...
		subtitle = "Ice Tiger";
		description = "Uncle: no intel on that Tiger squadron will cost us dearly during the campaign!";
		pictureBackground = "Img\intro_day8.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
	class Killed
	{
		...
		subtitle = "Riga Hill";
		description = "Uncle: we needed those tanks tracked commander! Unacceptable!";
		pictureBackground = "Img\intro_day8.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};		
};
