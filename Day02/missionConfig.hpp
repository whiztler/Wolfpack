...
{  
	class End1
	{
		...
		description = "Jetson: Well done men. Vodka and medals await upon your return!";
	...
	class End2
	{
		...
		subtitle = "Operation Kajman Fire";
		description = "Jetson: Now we have to deal with the Kajman's in battle. That's bad news Commander!";
		pictureBackground = "Img\intro_day2.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
	class Killed
	{
		...
		subtitle = "Operation Kajman Fire";
		description = "Jetson: Wolf 1,2 and 3 are M.I.A. Mission Failed...";
		pictureBackground = "Img\intro_day2.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};	
};
