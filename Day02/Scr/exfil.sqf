...
if (hasInterface) then {
	hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Jetson: Excellent work Scarecrow. Condor is on its way to pick you up at Krya Nera Beach, </t><t color='#9DA698' align='left'>LZ Seattle<br /></t>";
	...
	hintSilent parseText "<img size= '5' shadow='false' image='Img\soar_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Scarecrow, this is Condor. We're coming in from the north-west. </t><t color='#9DA698' align='left'>ETA 8 mikes.<br /></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
...
if (isServer) then { 
	...
	_wp2 setWaypointStatements ["true", "hintSilent parseText""<img size= '5' shadow='false' image='Img\soar_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Condor: Scarecrow please pop smoke or a chemlight to mark the LZ.<br /></t>"";"];
	...
	_wp3 setWaypointStatements ["true", "vCondor1 land 'LAND';vCondor2 land 'LAND';hintSilent parseText""<img size= '5' shadow='false' image='Img\soar_logo.paa'/><br/><br/><t color='#6C7169' align='left'>160th SOAR Lt. Summers: Dusting off in 30 seconds!<br /></t>"";vCondor1 flyInHeight 15;vCondor2 flyInHeight 15;"];	
