...
_toma = createTrigger ["EmptyDetector", getMarkerPos "gbu1"];
_toma setTriggerType "NONE";
_toma setTriggerActivation ["DELTA", "PRESENT", false];
_toma setTriggerArea [0,0,0,false];
_toma setTriggerText "Call in the Tomahawk strike @ Krya Nera";
waituntil {triggeractivated _toma;};

Sleep 5;
hint parseText"<t color='#6C7169' align='left'>USS Marauder: Fire mission received. Fire for Effect, R, F, Compact Explosive Tactical Missile.</t>";
Sleep 10;
hintSilent parseText"<t color='#6C7169' align='left'>USS Marauder: R, F, Compact Explosive Tactical Missile in effect, 1 missile out.</t>";
Sleep 6;
hintSilent parseText"<t color='#6C7169' align='left'>USS Marauder: Shot out.</t>";
Sleep 5;
hintSilent parseText "<t color='#6C7169' align='left'>USS Marauder: Splash in 55.</t>";
sleep 55;
hint parseText "<t color='#6C7169' align='left'>USS Marauder: Splash out.</t>";
sleep 5;
hint parseText "<t color='#6C7169' align='left'>USS Marauder: Fire mission complete.</t>";
sleep 2;
...
hint parseText"
	<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/>
	<t color='#6C7169' align='left'>Jetson: Scarecrow, make your way to the Abdera Airfield.<br/></t>
";
_logTime = [dayTime] call BIS_fnc_timeToString;
_logTimeText = "Log: " + _logTime;
player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
