...
player createDiaryRecord ["Diary",["Basic Training","
<font color='#9da698' size='14'>PREREQUISITES</font><br/>
<font color='#6C7169'>- Standard Operating Procedures<br/>
- ACRE/TFAR communication skills (incl. whisper mode)<br/>
- Standard patrol tactics<br/>
- Marksman qualification is recommended.</font>
...
- Path finding<br/>
- Team tactics/Role Specific<br/>
- Insert/Exfil tactics<br/>
- Comms tactics

<br/><br/>Qualification/Result:</font><font color='#9da698' size='14'> Special Operations / Recon Assault Specialist</font>
...
- Using the map for planning LR stealth patrol. Usage of terrain to the utmost advantage.<br/>
- Communication. Only base essential communication. No chit-chat whatsoever! Direct/whisper comm (no radio).<br/>
- Team construction. Right fooks in the right role? Split up teams to get best result. Why/How?<br/>
- Patrol strategy. Distance, 2 man recon patrol/path finder. Point rotation.<br/>
- Leadership capabilities en-route. Driving the teams. Constant environment awareness.<br/><br/>

Map reading/using/planning instructions can be given during the mission init phase when all players go from the lobby to the map screen. Instructor will need 10-15 minutes to go through previously mentioned topics/skill sets.<br/><br/>

Leadership will get 10 minutes ingame times to prepare/brief.</font>
"]];
...
<br/><br/><font color='#9da698' size='14'>BASIC TRAINING OBJECTIVE</font><br/>
...
<font color='#6C7169'>This training exercise starts at around 02:00 hrs. Clear weather, high humidity, medium visibility. Forecast: medium visibility, clear skies.</font>
"]];