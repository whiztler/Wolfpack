...
if (hasInterface) then {
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>DEVGRU: Commander, call signs are as follows:<br/><br/>DEVGRU TOC: </t><t color='#9DA698' align='left'>Big Foot.</t><br /><t color='#6C7169' align='left'>Your call sign: </t><t color='#9DA698' align='left'>Phoenix.<br /></t>";
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Big Foot: Phoenix, make your way to the </t><t color='#9DA698' align='left'>RV</t><t color='#6C7169' align='left'> location.<br/><br/>At the RV you'll be briefed by our local man on the ground, Nikos Fotopoulos.<br /></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
...
if (isServer) then {[wolfCrate] execVM "Core\C\ADF_cCargo_B_SpecOps.sqf"};

[] spawn {
	waitUntil {sleep 5; Retaliate};	
	sleep 120;
	if (hasInterface) then {
		hint parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Big Foot: Phoenix, SatNav reports a Kajman gunship just took off from Abdera Heliport and is heading towards Frini. ETA 3 Mikes.<br /></t>";
		_logTime = [dayTime] call BIS_fnc_timeToString;
		_logTimeText = "Log: " + _logTime;
		player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
		<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
...
Kallaziz_1 addMPEventhandler ["MPkilled", {0 = execVM "Scr\kallaziz.sqf"; Retaliate = true; publicVariableServer "Retaliate";}];
...
if (ADF_HC_execute) then {
	...
	if (ADF_patrols) exitWith {};
	ADF_patrols = true; publicVariable "ADF_patrols";
