...
call compileFinal preprocessFileLineNumbers "Core\TP\zbe_cache\zbe_functions.sqf";
...
<t color='#A1A4AD' align='left'>Cached vehicles:</t><t color='#00ff33' align='right'>%6</t><br/><br/>
...
// if (!isDedicated) then {execFSM "Core\TP\zbe_cache\zbe_clientObjectDrawAuto.fsm";};