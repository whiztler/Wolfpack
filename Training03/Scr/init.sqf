...
if (isServer) then { 
	...
	[getMarkerPos "mAF4", getMarkerPos "mAFx", 15, "NORMAL", "O_Heli_Attack_02_F", EAST] call BIS_fnc_ambientFlyby; sleep 0.035;
};
...
for "_i" from 21 to 24 do {
	...
	_spawnPos = format ["mEIP_%1",_i];
	_g = [getMarkerPos _spawnPos, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfSentry")] call BIS_fnc_spawnGroup;
	[_g, getMarkerPos _spawnPos, 150, 4, "MOVE", "SAFE", "YELLOW", "LIMITED", "COLUMN", "this spawn CBA_fnc_taskSearchHouse", [1,4,9]] call CBA_fnc_taskPatrol;
	sleep 1;
};
...
[] spawn {
	...
	_wp = _c addWaypoint [getMarkerPos "mWP_1a", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1b", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1c", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1d", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1e", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1f", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1g", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1h", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1i", 0]; _wp setWaypointType "CYCLE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED"; sleep _pause;
	...
	_v = [getMarkerPos "mVehSpawn_1", 0, _vObject, _c] call BIS_fnc_spawnVehicle;
	_v select 0 allowDamage false;
	_wp = _c addWaypoint [getMarkerPos "mWP_1i", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1h", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1g", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1f", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1e", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	...
	_wp = _c addWaypoint [getMarkerPos "mWP_1c", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1b", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1a", 0]; _wp setWaypointType "CYCLE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED"; sleep _pause;
	...
	_wp = _c addWaypoint [getMarkerPos "mWP_1a", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1b", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_2d", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_2c", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_2b", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_2a", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1e", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1d", 0]; _wp setWaypointType "MOVE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED";
	_wp = _c addWaypoint [getMarkerPos "mWP_1c", 0]; _wp setWaypointType "CYCLE"; _wp setWaypointBehaviour "SAFE"; _wp setWaypointSpeed "LIMITED"; sleep _pause;
...
[] spawn {
	...
	for "_i" from 1 to 5 do {
		_c = createGroup EAST;
		_vPool = call selectVehPoolTTL;				
		_v = [getMarkerPos "mVehSpawn_2", 0, _vPool, _c] call BIS_fnc_spawnVehicle;
		[_c, getmarkerpos "mVehSpawn_2", 3500, 7, "MOVE", "SAFE", "RED", "LIMITED", "", "", [3,6,9]] call CBA_fnc_taskPatrol;
