...
_ADF_unit addWeapon "ItemWatch"; _ADF_unit addWeapon "ItemCompass";
...
if ((_ADF_unit == RTL_1) || (_ADF_unit == RTL_2)) then {
	if (ADF_mod_CTAB) then {(vestContainer _ADF_unit) addItemCargoGlobal ["ItemAndroid",1];};
