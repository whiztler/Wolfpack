...
_ADF_add_NVGoggles = false; // add NV Goggles as default loadout [true/false].
_ADF_add_GPS = false; // Enable GPS for all unit (true) or only specialist/leadership roles (false).
_ADF_Thermal = false; // Enable/disable thermal imaging equipment such as FLIR [true/false].
// Weapons
...
ADF_VD_foot = 1750; // Maximum view distance on foot.
...
_ADF_devBuildNr = "12"; // Build number. DO NOT EDIT