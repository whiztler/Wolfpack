...
[] spawn {
	waitUntil {time > 21};
	["<img size= '10' shadow='false' image='Img\wpintro.paa'/><br/><br/><t size='.7' color='#FFFFFF'>Day 04 | Top Screen</t>",0,0,3,12] spawn BIS_fnc_dynamicText;
};
...
hint parseText"
	...
	<t color='#6C7169' align='left'>DEVGRU: Commander, call signs are as follows:<br/><br/>DEVGRU TOC: </t><t color='#9DA698' align='left'>Mother.</t><br /><t color='#6C7169' align='left'>Your call sign: </t><t color='#9DA698' align='left'>Rattler.<br/></t>
";
...
while {(_cnt != 40)} do {
	...
	hintSilent parseText"
		<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/>
		<t color='#6C7169' align='left'>Mother: Rattler, as per the briefing earlier today, please insert at your own accord. Your options are:</t><br/><br/>
		<t color='#6C7169' align='left'>1. RV ALPHA<br/>Rendezvous with </t><t color='#9DA698' align='left'>Dimitri/Nikos</t><t color='#6C7169' align='left'>. They'll have vehicles for you to use for transport. Distance to AO: approx </t><t color='#9DA698' align='left'>7</t><t color='#6C7169' align='left'> km's.</t><br/><br/>
		<t color='#6C7169' align='left'>2. RV HOTEL<br/>Just south of </t><t color='#9DA698' align='left'>Faronaki</t><t color='#6C7169' align='left'>. This RV area is patrolled by CSAT naval forces. Distance to AO: approx </t><t color='#9DA698' align='left'>3</t><t color='#6C7169' align='left'> km's.</t><br/><br/>
		<t color='#6C7169' align='left'>3. RV ZULU<br/>The island of </t><t color='#9DA698' align='left'>Chelonisi</t><t color='#6C7169' align='left'> is considered free of CSAT forces. The bay west of it is patrolled by the CSAT navy. Distance to AO: approx </t><t color='#9DA698' align='left'>950</t><t color='#6C7169' align='left'> meters.<br/></t>
	";
	sleep 1;
};
_logTime = [dayTime] call BIS_fnc_timeToString;
...
hint parseText"
	<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/>
	<t color='#6C7169' align='left'>Mother: Since you have some time before you reach your RV, I suggest brief your RTL's re your tactical plan/MO.<br/></t>
";
_logTime = [dayTime] call BIS_fnc_timeToString;
_logTimeText = "Log: " + _logTime;
player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
...
vAP2 = _v select 0;
[_c, getMarkerPos "cBase1", 7500, 8, "MOVE", "SAFE", "YELLOW", "LIMITED", "", "", [3,6,9]] call CBA_fnc_taskPatrol;
sleep 2;
