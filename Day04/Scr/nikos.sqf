if (hasInterface) then {
	...
	while {(_cnt != 40)} do {
		_cnt = _cnt + 1;
		hintSilent parseText"<t color='#6C7169' align='left'>Ahhh Commander, good to see you my friend. Welcome to one of our camps.</t><br/><br/><t color='#6C7169' align='left'>I understand you are going to sabotage the ABC headquarters. It is about time we get rid of CSAT propaganda.</t><br/><t color='#6C7169' align='left'>Pyrgos is well defended. A large army bases is just north of the ABC buildings. There is at least a battalion at the base. Beware of urban area's. CSAT has presence in every town now. And they patrol the entire peninsula actively.</t><br/><br/><t color='#6C7169' align='left'>I have </t><t color='#9DA698' align='left'>two trucks</t><t color='#6C7169' align='left'> waiting for your at our supply camp just north west of here, at </t><t color='#9DA698' align='left'>Livadi</t><t color='#6C7169' align='left'>. I asked the guys drop a chemlight for you at the camp. Beware of patrols. There are many!</t><br/><br/><t color='#6C7169' align='left'>Good luck Commander!<br/></t>";
		sleep 1;
	};
};
