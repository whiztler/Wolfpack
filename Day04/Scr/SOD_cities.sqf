...
// tCities1 (Panagia)
if ((isNil "g1a") && (isNil "g1b") && (_t == "1A")) exitWith {
...
// tCities2 (Faronaki)
if ((isNil "g2a") && (isNil "g2b") && (_t == "2A")) exitWith {
...
// tCities3 (Chalkeia)
if ((isNil "g3a") && (isNil "g3b") && (isNil "g3c") &&  (isNil "g3d") && (_t == "3A")) exitWith {
	g3a = [getPos tCities3, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam")] call BIS_fnc_spawnGroup;
	[g3a, getPos tCities3, 300, 4, "MOVE", "SAFE", "RED", "LIMITED","FILE", 5, true] call ADF_fnc_footPatrol;
	g3b = [getPos tCities3, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam")] call BIS_fnc_spawnGroup;
	[g3b, getPos tCities3, 300, 4, "MOVE", "SAFE", "RED", "LIMITED","FILE", 5, true] call ADF_fnc_footPatrol;
...
if ((isNil "gPa") && (isNil "gPb") && (isNil "gPc") && (isNil "gPd") && (isNil "gPe") && (isNil "gPf") && (isNil "gPg") && (_t == "5A")) exitWith {
	gPa = [getPos vPyrgosFlag, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam")] call BIS_fnc_spawnGroup;
	[gPa, getPos vPyrgosFlag, 500, 4, "MOVE", "SAFE", "RED", "LIMITED","FILE", 5, true] call ADF_fnc_footPatrol;
	gPb = [getPos vPyrgosFlag, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam")] call BIS_fnc_spawnGroup;
	[gPb, getPos vPyrgosFlag, 500, 4, "MOVE", "SAFE", "RED", "LIMITED","FILE", 5, true] call ADF_fnc_footPatrol;
...
// tCities5 (Charkia)
if ((isNil "g6a") && (isNil "g6b") && (isNil "g6c") &&  (isNil "g6d") && (isNil "g6e") && (_t == "6A")) exitWith {
	g6a = [getPos tCities6, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam")] call BIS_fnc_spawnGroup;
	[g6a, getPos tCities6, 300, 4, "MOVE", "SAFE", "RED", "LIMITED","FILE", 5, true] call ADF_fnc_footPatrol;
	g6b = [getPos tCities6, EAST, (configFile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam")] call BIS_fnc_spawnGroup;
	[g6b, getPos tCities6, 300, 4, "MOVE", "SAFE", "RED", "LIMITED","FILE", 5, true] call ADF_fnc_footPatrol;
	...
	[g6e, getPos tABC2, 100, 4, "MOVE", "SAFE", "RED", "LIMITED","FILE", 5, true] call ADF_fnc_footPatrol;
};
if (_t == "6B") exitWith {
