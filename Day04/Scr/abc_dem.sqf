...
if (hasInterface) then {
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Mother: Excellent job Rattler.</t><br/><br/><t color='#6C7169' align='left'>Proceed to exfil </t><t color='#9DA698' align='left'>Sydney</t><t color='#6C7169' align='left'>, just east of </t><t color='#9DA698' align='left'>Faronaki<br/></t>";
	...
	hintSilent parseText "<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#9DA698' align='left' size='1.5'>STANDBY!</t><br/><br/><t color='#6C7169' align='left'>Mother: Rattler, hold your position and standby for orders update. Out.<br/></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Mother: Rattler, additional orders:</t><br/><br/><t color='#6C7169' align='left'>Head towards </t><t color='#9DA698' align='left'>Charkia</t><t color='#6C7169' align='left'>, north of your current. There is a </t><t color='#9DA698' align='left'>storage facility</t><t color='#6C7169' align='left'> on the north side of the city.</t><br/><t color='#6C7169' align='left'>More updates to follow asap.<br/></t>";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
	...
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Mother: Rattler, apparently there are two spare generators at the storage facility.</t><br/><t color='#6C7169' align='left'>We need to take out those two generators. Find them and blow them to hell.</t><br/><br/><t color='#6C7169' align='left'>Niko's crew will leave you additional explosives at the entrance of the facility.</t><br/><br/><t color='#6C7169' align='left'>Good luck Rattler.<br/></t>	";
	_logTime = [dayTime] call BIS_fnc_timeToString;
	_logTimeText = "Log: " + _logTime;
	player createDiaryRecord ["Wolfpack Log", [_logTimeText,"
	<br/><br/><font color='#9da698' size='14'>From: JSOC TOC</font><br/>
