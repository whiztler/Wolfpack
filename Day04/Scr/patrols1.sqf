...
if ((isNil "g8") && (_this select 0 == "8A")) exitWith {
	...
	[g8, getPos tFP8, 500, 4, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
};
...
if ((isNil "g9") && (_this select 0 == "9A")) exitWith {
	...
	[g9, getPos tFP9, 500, 4, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
};
...
if ((isNil "g10") && (_this select 0 == "10A")) exitWith {
	...
	[g10, getPos tFP10, 500, 4, "MOVE", "SAFE", "RED", "LIMITED", "FILE", 5] call ADF_fnc_footPatrol;
};
