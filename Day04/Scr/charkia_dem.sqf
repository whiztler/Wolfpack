...
if (hasInterface) then {
	hintSilent parseText"<img size= '5' shadow='false' image='Img\jsoc_logo.paa'/><br/><br/><t color='#6C7169' align='left'>Mother: Job well done Rattler!</t><br/><br/><t color='#6C7169' align='left'>Time to come home. Head to </t><t color='#9DA698' align='left'>LZ Romeo</t><t color='#6C7169' align='left'> in the </t><t color='#9DA698' align='left'>Limni Swamps.<br/></t>";
